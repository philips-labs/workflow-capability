    ...
    public static void main(String[] args) {
        try (AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext()) {
            ...
            if (args.length > 0) {
                ...
                System.err.println("No arguments provided. Running with default preprocessing step" );
                fhirStoreInitialization.run();
                System.out.println("Preprocessing step completed");
            }
        
        } catch (BeansException | IllegalStateException e) {
            System.out.println("An error occured while running the preprocessing step");
            e.printStackTrace();
        }
