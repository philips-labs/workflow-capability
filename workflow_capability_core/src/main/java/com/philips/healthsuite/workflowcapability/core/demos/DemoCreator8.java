 ...
 * <p>
 * This patient has sepsis but does not need surgery. He will get a prescription.
 */
@Component
@PropertySource("classpath:application.properties")
public class DemoCreator8 {
    ...
    public void run() {
        ...
        Patient patient = demoPatientCreator.createPatient("Joe", "the Eighth", 8);
