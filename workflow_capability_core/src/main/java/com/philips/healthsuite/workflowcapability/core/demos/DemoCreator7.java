 ...
 * <p>
 * This patient is sober but does not have bad physiological measurements. Therefore, he will be discharged after initial tests.
 */
@Component
@PropertySource("classpath:application.properties")
public class DemoCreator7 {
    ...
    public void run() {
        ...
        Patient patient = demoPatientCreator.createPatient("Joe", "the Seventh", 7);
        ...
        addTemperatureObservation(patientOutcome);
     ...
     */
    public void addTemperatureObservation(MethodOutcome patientOutcome) {
