 ...
 * <p>
 * For {@link CodeableConcept} see https://fhirblog.com/2013/10/22/fhir-coding-and-the-codeableconcept-datatype/
 */
@Component
@PropertySource("classpath:application.properties")
public class DemoCreator1 {
    ...
    public void run() {
        ...
        Patient patient = demoPatientCreator.createPatient("Joe", "van Juan", 1);
